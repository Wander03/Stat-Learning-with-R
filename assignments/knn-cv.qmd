...
ggplot() +
  geom_point(aes(x = whr_clean$healthy_life_expectancy, y = knn_resid)) +
...
dashed lines. The residuals plot looks better than the plot from the linear 
model, showing less of a linear pattern and more random.
