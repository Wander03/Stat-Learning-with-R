...
results_knn %>% slice_max(ROC_AUC, n = 5) %>% kable()
```
...
results_logreg %>% slice_max(ROC_AUC, n = 5) %>% kable()
```
...
results_lda %>% slice_max(ROC_AUC, n = 5) %>% kable()
```
...
results_qda %>% slice_max(ROC_AUC, n = 5) %>% kable()
```
...
rbind(roc_auc_knn, precision_knn, recall_knn) %>% kable()
results_knn %>% slice_max(ROC_AUC) %>% kable()
```
...
rbind(roc_auc_logreg, precision_logreg, recall_logreg) %>% kable()
results_logreg %>% slice_max(ROC_AUC) %>% kable()
```
...
rbind(roc_auc_lda, precision_lda, recall_lda) %>% kable()
results_lda %>% slice_max(ROC_AUC) %>% kable()
```
...
rbind(roc_auc_qda, precision_qda, recall_qda) %>% kable()
results_qda %>% slice_max(ROC_AUC) %>% kable()
```
