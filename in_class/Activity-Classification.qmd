...
ins <- ins %>%
  mutate(
    predicted_smoker_1 = predict(fit_1, ins)$.pred_class,
    predicted_smoker_2 = predict(fit_2, ins)$.pred_class,
    predicted_smoker_3 = predict(fit_3, ins)$.pred_class
  ) 

ins %>%
  accuracy(truth = smoker,
           estimate = predicted_smoker_1)

ins %>%
  accuracy(truth = smoker,
           estimate = predicted_smoker_2)

ins %>%
  accuracy(truth = smoker,
           estimate = predicted_smoker_3)
```
